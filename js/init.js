	...
	var _settings = {
		...
		// skelJS
			skelJS: {
				...
				useOrientation: true,
				breakpoints: {
					'widest': { range: '*', containers: '100%', grid: { gutters: 50 }, hasStyleSheet: false },
					'wide': { range: '-1680', containers: '100%', grid: { gutters: 40 } },
					'normal': { range: '-1280', containers: '100%', grid: { gutters: 30 }, lockViewport: true },
